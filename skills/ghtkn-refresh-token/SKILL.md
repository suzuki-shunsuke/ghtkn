...
- Supported only on the `agent` backend on macOS and Linux (not Windows, keyring, or text) - intentionally, for security. Do not use it where malware can easily escalate to root (many dev containers/VMs).
