...
// TestServer_startDeviceFlow_adoptsInProgressFlow verifies that a start for a client
...
func TestServer_startDeviceFlow_adoptsInProgressFlow(t *testing.T) {
	t.Parallel()
...
// TestServer_handleGet_awaitFailedFlow verifies that once a device flow has failed
...
func TestServer_handleGet_awaitFailedFlow(t *testing.T) {
	t.Parallel()
	c := newUnlockedServer(t)
...
// TestServer_handleGet_failedFlowClearedByNonAwait verifies that a non-waiting GET
...
func TestServer_handleGet_failedFlowClearedByNonAwait(t *testing.T) {
	t.Parallel()
	c := newUnlockedServer(t)
